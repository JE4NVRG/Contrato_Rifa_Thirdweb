//SPDX-License-Indenfier: UNLICENSED
...
contract NFTRaffleContract {
    ...
    function selectWinner() public onlyOwner {
        require(!raffleStatus, " Raflle is still running");
        require(playerSelector.length > 0, "No players in the raffle");
        require(nftAddress != address(0), "NFT Prize is not set");

        uint256 winnerIndex = ramdom();
